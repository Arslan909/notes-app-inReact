...
export default function Editor(props) {
    ...
    }, [props.noteId, props.noteTitle, props.noteDescription ])
    ...
    function handelChange(event) {
        ...
        // EditorData.editorContent = event.target.value
        // props.setNoteDescription(event.target.value);
        setEditorData({
            ...EditorData,
    ...
    }, [selectedTab, props.noteId , props.noteTitle, props.noteDescription ])
...
// {EditorData.editorContent !== "" ? change it to check fot null instead
